            ...
            return function(scope, element, attr) {
                ...
                element.on('dragstart', function(event) {
                    ...
                    dndState.effectAllowed =
                        attr.dndEffectAllowed || ALL_EFFECTS[0];
                    ...
                    var mimeType =
                        MIME_TYPE +
                        (dndState.itemType ? '-' + dndState.itemType : '');
                    try {
        ...
        function($parse) {
            return function(scope, element, attr) {
                ...
                element.on('dragenter', function(event) {
                    ...
                    var types =
                        attr.dndAllowedTypes &&
                        scope.$eval(attr.dndAllowedTypes);
                    listSettings = {
                        allowedTypes:
                            ...
                            types
                                ...
                                .split('|'),
                        disabled:
                            attr.dndDisableIf && scope.$eval(attr.dndDisableIf),
                        externalSources:
                            attr.dndExternalSources &&
                            scope.$eval(attr.dndExternalSources),
                        horizontal:
                            attr.dndHorizontalList &&
                ...
                element.on('dragleave', function(event) {
                    ...
                    var newTarget = document.elementFromPoint(
                        event.clientX,
                        event.clientY
                    );
                ...
                function getItemType(mimeType) {
                    ...
                    if (
                        ...
                        return null;
                    return (
                        (mimeType && mimeType.substr(MIME_TYPE.length + 1)) ||
                        undefined
                    );
                }
                ...
                function isDropAllowed(itemType) {
                    ...
                    return (
                        itemType &&
                        listSettings.allowedTypes.indexOf(itemType) != -1
                    );
                }
                ...
                function invokeCallback(
                    ...
                    return $parse(expression)(scope, {
                        ...
                        index:
                            index !== undefined ? index : getPlaceholderIndex(),
                        item: item || undefined,
                        type: itemType,
                    });
                }
